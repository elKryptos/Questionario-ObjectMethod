...
import it.objectmethod.questionario2024.Questionario2024Application;
 ...
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = Questionario2024Application.class)
@ActiveProfiles({"test"})
@Sql(scripts = {
        "classpath:/dbH2/01-truncate.sql",
        "classpath:/dbH2/02-insertIntoDomanda.sql",
        "classpath:/dbH2/03-insertIntoRisposta.sql",
        "classpath:/dbH2/04-insertIntoUtente.sql"
...
public abstract class BaseIntegrationtest {
    ...
    public void clearCache() {
        if (cacheManager != null) {
            this.cacheManager
                    .getCacheNames()
                    .forEach(cache -> Objects.requireNonNull(this.cacheManager.getCache(cache))
                            .clear());
        }
    }
